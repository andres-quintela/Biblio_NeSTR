...
\title[Multitask and Transfer revie]{Deep RL literature review on multitask and transfer}

\author[A. Quintela]{\small \textbf{Andrés Quintela}\\ Supervisor: Emmanuel Rachelson\inst{2}}
...
\begin{minipage}{0.5\linewidth}
  \begin{center}
    \inst{1} ISAE Supaero, Erasmus student\\
